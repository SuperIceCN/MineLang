...
public final class MineBigInteger implements TruffleObject, Comparable<MineBigInteger> {
    ...
    public MineBigInteger(BigInteger value) {
        this.value = value;
    }

    public MineBigInteger(long value) {
    ...
    public int compareTo(MineBigInteger o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MineBigInteger o) {
